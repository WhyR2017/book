...
Przemysław Biecek, \textit{Uniwersytet Warszawski}, \textit{Politechnika Warszawska}, \textit{MI$^{2}$}
...
Alicja Gosiewska, \textit{Politechnika Warszawska}, \textit{MI$^{2}$}

Aleksandra Dąbrowska, \textit{Uniwersytet Warszawski}, \textit{MI$^{2}$}

Monika Stępień, \textit{Uniwersytet Warszawski}
...
\subfile{abstracts/PC02_Kosinski.tex}\newpage
